...
class TsserverBridge {
    ...
    logRequest(command, args, result, durationMs, upstreamId) {
        ...
        const fileLabel = file ? (0, paths_1.relativeWorkspacePath)(file) : "workspace";
        ...
        if (command === "_vue:projectInfo") {
            ...
            const configLabel = configFileName ? (0, paths_1.relativeWorkspacePath)(configFileName) : "none";
